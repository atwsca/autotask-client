 ...
 */
class ContractServiceAdjustmentPaginator
{
    /** @var ContractServiceAdjustmentCollection Collection of ContractServiceAdjustments. */
    public ContractServiceAdjustmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractServiceAdjustmentCollection::fromResponse($response);
