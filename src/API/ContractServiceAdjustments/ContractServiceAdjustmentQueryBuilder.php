 ...
 */
class ContractServiceAdjustmentQueryBuilder
{
     ...
     */
     ...
     {
         $response = $this->client->get("ContractServiceAdjustments/query/count", [
     ...
     * Runs the query.
     */
    public function get(): ContractServiceAdjustmentCollection
    {
        $response = $this->client->get("ContractServiceAdjustments/query", [
            'search' => json_encode( $this->toArray() )
        ]);
    ...
    public function __toString()
    {
        $uri = UriResolver::resolve(
            ...
            new Uri('ContractServiceAdjustments/query')
        );
