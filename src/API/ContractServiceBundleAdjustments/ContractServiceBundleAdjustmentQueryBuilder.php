 ...
 */
class ContractServiceBundleAdjustmentQueryBuilder
{
     ...
     */
     ...
     {
         $response = $this->client->get("ContractServiceBundleAdjustments/query/count", [
     ...
     * Runs the query.
     */
    public function get(): ContractServiceBundleAdjustmentCollection
    {
        $response = $this->client->get("ContractServiceBundleAdjustments/query", [
            'search' => json_encode( $this->toArray() )
        ]);
     ...
     */
    public function paginate(): ContractServiceBundleAdjustmentPaginator
    {
        $response = $this->client->get("ContractServiceBundleAdjustments/query", [
            'search' => json_encode($this->toArray())
        ]);

        return new ContractServiceBundleAdjustmentPaginator($this->client, $response);
    }
    ...
    public function __toString()
    {
        $uri = UriResolver::resolve(
            ...
            new Uri('ContractServiceBundleAdjustments/query')
        );
