 ...
 */
class ContractServiceBundleAdjustmentPaginator
{
    /** @var ContractServiceBundleAdjustmentCollection Collection of ContractServiceBundleAdjustments. */
    public ContractServiceBundleAdjustmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractServiceBundleAdjustmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractServiceBundleAdjustmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractServiceBundleAdjustmentPaginator
    {
